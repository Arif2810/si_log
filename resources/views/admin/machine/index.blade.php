            ...
            <div class="col-xs-12">
                <div class="box" style="padding: 0 30px">
                  <div class="box-header">
                    <div class="box-header">
                      <h5 class="box-title">Tambah data mesin</h5>
                    </div>
                    <div class="box-body">
                      @include('admin/validation')
                      <form action="{{ url('/machine') }}" method="post">
                        <div>
                          <label>Nama Mesin</label>
                          <!-- <input class="form-control" type="text" name="nama_mesin"> -->
                          {!!Form::text('nama_mesin', null, ['class'=>'form-control'])!!}
                        </div><br><br>
                        <div>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('machine') }}/{{$machine->id_mesin}}/edit"><button class="btn btn-warning btn-xs">Edit</button></a>
                        <button class="btn btn-danger btn-xs" data-delid={{$machine->id_mesin}} data-toggle="modal" data-target="#delete"><i class="glyphicon glyphicon-trash"></i> Hapus</button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
    ...
    <div class="modal-content" style="background-color: rgb(200, 200, 200)">
      ...
      <form action="{{route('machine.destroy', 'test')}}" method="post">
        ...
        <div class="modal-body" style="background-color: rgb(230, 230, 230)">
          ...
          <input type="hidden" name="id_mesin" id="del_id" value="">
        </div>
